      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-4 text-sm md:text-base font-medium leading-relaxed mb-8">
            <p className="bg-blue-100 border-l-4 border-os-border pl-4 py-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="border-3 border-os-border p-3 bg-green-100 flex flex-col justify-center">
               <span className="font-mono text-xs font-bold mb-1">FOCUS</span>
               <span className="font-bold">Cloud-Native Architectures</span>
            </div>
            <div className="border-3 border-os-border p-3 bg-purple-100 flex flex-col justify-center">
