...
export default function TimelineApp() {
  ...
  return (
    <div className="bg-black text-green-400 p-4 font-mono text-xs md:text-sm h-full flex flex-col">
      <div className="border-b-2 border-green-800 pb-2 mb-4 flex justify-between items-center text-green-600">
