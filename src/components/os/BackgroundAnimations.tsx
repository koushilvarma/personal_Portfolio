...
const shapes = [
  ...
  { id: 5, type: 'icon', icon: Database, label: 'Storage', color: 'text-yellow-500', size: 45, startX: 15, startY: 50 },
  { id: 6, type: 'icon', icon: Server, label: 'Server', color: 'text-purple-500', size: 60, startX: 85, startY: 45 },
  { id: 7, type: 'icon', icon: Cpu, label: 'Core', color: 'text-gray-500', size: 55, startX: 5, startY: 85 },
  { id: 8, type: 'icon', icon: Globe, label: 'Network', color: 'text-cyan-500', size: 50, startX: 90, startY: 70 },
  { id: 9, type: 'icon', icon: FileText, label: 'Resume', color: 'text-yellow-400', size: 60, startX: 40, startY: 80 },
  { id: 10, type: 'icon', icon: Gamepad2, label: 'Gaming', color: 'text-purple-400', size: 50, startX: 30, startY: 85 },
  { id: 11, type: 'icon', icon: MessageSquare, label: 'Chat', color: 'text-green-400', size: 50, startX: 85, startY: 35 },
  { id: 12, type: 'icon', icon: Rocket, label: 'Launch', color: 'text-orange-400', size: 60, startX: 70, startY: 60 },
